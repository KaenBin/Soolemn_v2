...
declare class SDK {
     ...
     */
    assets_create(body: types.AssetsCreateBodyParam): Promise<FetchResponse<200, types.AssetsCreateResponse200>>;
    /**
     * Update an asset.
     *
     * Required authorization scope: `Asset`
     ...
     */
    addresses_delete(metadata: types.AddressesDeleteMetadataParam): Promise<FetchResponse<200, types.AddressesDeleteResponse200>>;
    /**
     ...
     */
    courier_accounts_couriers_index(metadata: types.CourierAccountsCouriersIndexMetadataParam): Promise<FetchResponse<200, types.CourierAccountsCouriersIndexResponse200>>;
    /**
     ...
     */
    courier_accounts_deactivate(metadata: types.CourierAccountsDeactivateMetadataParam): Promise<FetchResponse<200, types.CourierAccountsDeactivateResponse200>>;
    /**
     ...
     */
    courier_accounts_index(metadata?: types.CourierAccountsIndexMetadataParam): Promise<FetchResponse<200, types.CourierAccountsIndexResponse200>>;
    /**
     ...
     */
    courier_accounts_create(body?: types.CourierAccountsCreateBodyParam): Promise<FetchResponse<201, types.CourierAccountsCreateResponse201> | FetchResponse<202, types.CourierAccountsCreateResponse202>>;
    /**
     ...
     */
    courier_accounts_show(metadata: types.CourierAccountsShowMetadataParam): Promise<FetchResponse<200, types.CourierAccountsShowResponse200>>;
    /**
     ...
     *
     *
     * @summary Update a Courier Account
     * @throws FetchError<404, types.CourierAccountsUpdateResponse404> record not found
     * @throws FetchError<422, types.CourierAccountsUpdateResponse422> failed validations
     */
    courier_accounts_update(body: types.CourierAccountsUpdateBodyParam, metadata: types.CourierAccountsUpdateMetadataParam): Promise<FetchResponse<200, types.CourierAccountsUpdateResponse200>>;
    courier_accounts_update(metadata: types.CourierAccountsUpdateMetadataParam): Promise<FetchResponse<200, types.CourierAccountsUpdateResponse200>>;
    /**
     * Bulk update for a list of couriers.
     *
     * It requires a `Courier` authorization scope enabled on the API key.
     *
     *
     * @summary Bulk update of Courier Account's Couriers
     * @throws FetchError<404, types.CourierAccountsCouriersBulkUpdateResponse404> non-existing courier account
     * @throws FetchError<422, types.CourierAccountsCouriersBulkUpdateResponse422> courier update error
     */
    courier_accounts_couriers_bulk_update(body: types.CourierAccountsCouriersBulkUpdateBodyParam, metadata: types.CourierAccountsCouriersBulkUpdateMetadataParam): Promise<FetchResponse<200, types.CourierAccountsCouriersBulkUpdateResponse200>>;
    courier_accounts_couriers_bulk_update(metadata: types.CourierAccountsCouriersBulkUpdateMetadataParam): Promise<FetchResponse<200, types.CourierAccountsCouriersBulkUpdateResponse200>>;
    /**
     ...
     */
    courier_estimated_delivery_dates_index(metadata: types.CourierEstimatedDeliveryDatesIndexMetadataParam): Promise<FetchResponse<200, types.CourierEstimatedDeliveryDatesIndexResponse200>>;
    /**
     ...
     */
    couriers_pickup_slots_index(metadata: types.CouriersPickupSlotsIndexMetadataParam): Promise<FetchResponse<200, types.CouriersPickupSlotsIndexResponse200>>;
    /**
     ...
     */
    labels_create(body?: types.LabelsCreateBodyParam): Promise<FetchResponse<201, types.LabelsCreateResponse201>>;
    /**
